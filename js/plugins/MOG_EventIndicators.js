...
/*:ja
 * @plugindesc (v1.0) イベント上にアニメーションインジケータを表示します。
 * @author Moghunter
 *
 ...
 * ===========================================================================
 * イベント上にアニメーションインジケータを表示します。
 *
 * ===========================================================================
 * 必要画像
 * ===========================================================================
 * インジケータ画像を下記フォルダーに保存してください。
 * /img/eventidicators/
 *
 * ---------------------------------------------------------------------------
 * アニメーション (フレーム)
 * ---------------------------------------------------------------------------
 * アニメーション機能を有効にする場合、次のように画像に名前を付けます。
 *
 * FILENAME + _INDEX.png
 *
 * 例
 ...
 * 注釈 (イベント)
 * ===========================================================================
 * インジケータを有効にします。イベントに以下の注釈を入れます。
 * 注釈は1行ずつ別々に入れる必要があります。
 *
 * ---------------------------------------------------------------------------
 *
 ...
 *
 * 使用例1（画像表示）
 * ◆注釈：indicator : Hell_0 : 0 : 0
 *
 * 使用例2（画像の上にテキスト表示）
 * ◆注釈：indicator : Img_0 : 0 : 0
 * ◆注釈：text_indicator : テキスト
 *
 * 使用例3（フレームアニメ）
 * ◆注釈：indicator : Img : 0 : 0
 * ◆注釈：animated_indicator : 3 : 30
 *
 * ===========================================================================
 * 拡張注釈 (オプション)
 * ===========================================================================
 ...
 *
 * ---------------------------------------------------------------------------
 * VARIABLE_ID - 変数のID。変数値を表示します。
 *
 * variable_indicator : VARIABLE_ID
 *
 * ---------------------------------------------------------------------------
 * RANGE - 距離。距離内にプレイヤーがいる間だけ表示します。
 *
 * range_indicator : RANGE
 *
 * ---------------------------------------------------------------------------
 * FRAMES - アニメのフレーム数
 * ANIMATION_SPEED - フレームを切り替えるウェイト
 *
 ...
 *
 * ---------------------------------------------------------------------------
 * ROTATION_SPEED - 回転アニメの速度。(例：0.1 / -0.1)
 *                    正:時計回り / 負:反時計回り。絶対値が大きいほど高速。
 *
 * rotation_indicator : ROTATION_SPEED
 *
 * ---------------------------------------------------------------------------
 * SHAKE_POWER - シェイクアニメの振れ幅。
 *
 * shake_indicator : SHAKE_POWER
 * ---------------------------------------------------------------------------
 * PULSE_POWER - パルスアニメの拡大率。(例：0.01)
 *
 * pulse_indicator : PULSE_POWER
 *
 * ---------------------------------------------------------------------------
 * FLOAT - フロートアニメーションを有効にします。
 *
 * float_indicator
 *
 * ---------------------------------------------------------------------------
 * SLIDE - スライドアニメーションを有効にします。
 *
 * slide_indicator
 *
 * ---------------------------------------------------------------------------
 ...
 * プラグインコマンド
 * ===========================================================================
 * 以下のコマンドで、インジケータを表示/非表示にします。
 *
 * show_indicator : EVENT_ID
 * hide_indicator : EVENT_ID
 *
 * 以下のコマンドで、全てのインジケータを表示/非表示にします。
 *
 * show_all_indicators
 * hide_all_indicators
 *
 * ===========================================================================
 * 以下のプラグインコマンドでインジケータを有効にします。
 *
 * ---------------------------------------------------------------------------
 *
 ...
 * ---------------------------------------------------------------------------
 *
 * blendmode_indicator : EVENT_ID : BLEND_MODE
 *
 * ---------------------------------------------------------------------------
 *

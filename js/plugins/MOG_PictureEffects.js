...
/*:
 * @plugindesc (v1.4) Adiciona novas funcoes no sistema de mostrar imagens.
 * @author Moghunter
 * 
 * @help  
 * =============================================================================
 ...
 * https://atelierrgss.wordpress.com/
 * =============================================================================
 * Adiciona novas funcoes no sistema de mostrar imagens.
 * =============================================================================
 * UTILIZACAO.
 * =============================================================================
 * Utilize os comandos atraves do Plugin Command.
 *
 * =============================================================================
 * * POSITIONS * 
 * =============================================================================
 * --- > Posicao da imagem no player. < ----
 *
 * picture_player_position : PICTURE_ID
 *
 * --- > Posicao da imagem no evento. < ----
 *
 * picture_event_position : PICTURE_ID : EVENT_ID
 *
 * --- > Posicao fixa no mapa. < ----
 *
 * picture_map_position : PICTURE_ID
 * 
 *
 * (NOTA - A funcao MOVE nao funciona nos efeitos de Posicao.)
 *
 * =============================================================================
 * * EFFECTS * 
 * ============================================================================= 
 ...
 * picture_animated : PICTURE_ID : NUMBER_OF_FRAMES : ANIMATION_SPEED
 *
 * (NOTA - A largura da imagem e dividida pelo numero de frames.)
 *
 *
 * =============================================================================
 * * HISTORICO * 
 ...
 *       - Adicionado as opcoes de definir o poder e velocidade dos efeitos.
 * (1.2) - Adicionado a funcao de tremer no modo 2. 
 *
 */

 ...
 * 
 * @param ATB Max Value
 * @desc Definicao do tempo maximo de ATB  (Velocidade).
 * @default 4000
 * @type number 
 *
 * @param Turn Duration
 * @desc Definicao da duracao do turno.
 * @default 480
 * @type number 
 *
 * @param States Duration
 * @desc Definicao da duracao das condicoes.
 * @default 180
 * @type number 
 *
 * @param Escape Duration
 * @desc Definicao do tempo para escapar.
 * @default 180
 * @type number 
 *
 * @param Skip Emerge Message
 ...
 *
 * @param Full SE
 * @desc Definicao do som quando o ATB atingir o nivel maximo.
 * @type file
 * @default audio/se/Book1
 *
 * @param Change Actor Left
 * @desc Definicao do botao para mudar o personagem.
 * @default pagedown
 *
 * @param Change Actor Right
 * @desc Definicao do botao para mudar o personagem.
 ...
 *
 * @param Escape Button
 * @desc Definicao do botao para escapar.
 * @default cancel
 *
 * @param Escape Layout X
 * @desc Definicao da posicao do layout de fugir X-axis.
 * @default 600
 * @type number 
 *
 * @param Escape Layout Y
 * @desc Definicao da posicao do layout de fugir Y-axis.
 * @default 64
 * @type number 
 *
 * @param Escape Gauge X
 * @desc Definicao da posicao do medidor de fugir X-axis.
 * @default 6
 * @type number 
 *
 * @param Escape Gauge Y
 * @desc Definicao da posicao do medidor de fugir Y-axis.
 * @default 16
 * @type number 
 * 
 * @help  
 ...
 * IMAGES
 * =============================================================================
 * As imagens deverao ser gravadas na pasta. (img/atb/)
 * Imagens necessarias.
 *
 * Escape_A.png
 * Escape_B.png
 ...
 * 
 * 0 - Wait
 *     - Os inimigos nao atacam na selecao de comando.
 * 1 - Semi Active I
 *     - Os inimigos nao atacam na selecao de items/skills e selecao de alvo.
 * 2 - Semi Active II
 *     - Os inimigos nao atacam na selecao de items/skills.
 * 3 - Full Active
 *     - Os inimigos atacam em qualquer situacao.
 *
 * =============================================================================
 * CAST TIME
 * =============================================================================
 * Para definir o tempo de ativar uma acao (magias), defina pelo valor da
 * velocidade (Speed) da acao da habilidade ou item.
 *
 * =============================================================================
 * STATE DURATION
 * =============================================================================
 * Para definir o tempo da duracao da condicao, defina um valor em 
 *
 * Durations in Turns
 *
 * =============================================================================
 ...
 * =============================================================================
 * - (BUG FIX)     - Correcao de nao poder mudar de personagem durante a acao. 
 * 
 */

 ...
 * @param Full Gauge
 * @parent ---ATB 設定---
 * @desc ATBゲージが満たされる対象の速度。evalとして処理される式
  * @default Math.max(5000, BattleManager.highestBaseAgi() * 100)
 *
 * @param Charge Gauge
 * @parent ---ATB 設定---
 ...
 * @on 閃光させる
 * @off 閃光させない
 * @desc スキルをチャージし始めたとき、敵を閃光させる?
 * 閃光させない - false     閃光させる - true
 * @default true
 *
 * @param ---ラバーバンディング---
 * @default
 ...
 * パラメーターを'DefaultSystem'設定を'atb'に変更します。
 *
 ...
 * ============================================================================
 *
 * バトルシステムをアクティブターンバトルに変更すると
 * 戦闘システムで、次のプラグインコマンドを使用できます。
 *
 * プラグインコマンド:
 ...
 *
 * 上記のプラグインコマンドを使用して、
 * デフォルトバトルシステムとアクティブターンバトルを切り替えることができます。
 *
 * ============================================================================
 * Notetags
 * ============================================================================
 ...
 *   時々ATBを使用している間スキルが異なって実行するようにするかもしれません。
 ...
 *   それぞれのフェーズにある間にそれらのGaugeにのみ影響します。

...
/*:ja
 * @plugindesc (v1.4) アニメーションのフラッシュのタイミングで対象にダメージを与えます
 * @author Moghunter
 *
 * @help
 * 翻訳:ムノクラ
 ...
 * https://atelierrgss.wordpress.com/
 * ===========================================================================
 * アニメーションのフレーム（フラッシュ）のタイミングでダメージを与え、
 * アニメーション中に複数のダメージを与えることを可能にします。
 *
 * ===========================================================================
 * メモタグ
 * ===========================================================================
 * スキル/アイテムのメモ欄に下記のメモタグを入力してください。
 *
 * Flash Damage
 *
 * ダメージを与えるには、
 * スキル/アイテムにアニメーションを使用します。
 * そのアニメーションの「SEとフラッシュのタイミング」で
 * 「対象」が指定されている必要があります。
 *
 * スキル/アイテムの「連続回数」は無視され、
 * 「対象」が指定されているフラッシュの回数ダメージを与えます。
 * これには、フラッシュの指定が別フレームである必要があります。
 * 同フレームに複数の「SEとフラッシュ」を指定しても、
 * フレーム内で1回のダメージになります。
 *
 * ===========================================================================
 * - 更新履歴 (version 1.4)
 * ===========================================================================
 * (UPD) - Battler Motion 2.0との互換性
 *
 */

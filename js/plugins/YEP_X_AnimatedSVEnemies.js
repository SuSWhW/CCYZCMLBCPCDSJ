...
/*:ja
 * @plugindesc v1.19 (要YEP_BattleEngineCore.js)モーション付のサイドビューアクターを、敵にも用いることができます
 ...
 * @on オン
 * @off オフ
 * @desc スプライトスムージングをオンにします。(グローバルセッティング) オフ - false     オン - true
 * @default true
 *
 * @param Sprite Width
 * @parent ---一般---
 * @desc サイドビュースプライトの、最小幅を設定
 * 'auto'を入力すると自動で決定します。デフォルト: auto
 * @default auto
 *
 * @param Sprite Height
 * @parent ---一般---
 * @desc サイドビュースプライトの、高さの最小値を設定
 ...
 * @type number
 * @min 0
 * @desc モーション間で用いられる、デフォルトのフレームスピードを設定
 * デフォルト: 12
 * @default 12
 *
 ...
 * @parent ---影---
 * @desc 影の、デフォルトの水平方向(X)の大きさを設定
 * 'auto'を用いると自動で決定します。デフォルト: auto
 * @default auto
 *
 * @param Shadow Scale Y
 * @parent ---影---
 * @desc 影の、デフォルトの垂直方向(Y)の大きさを設定
 ...
 * @on 許可
 * @off 不許可
 * @desc 死んでいる間敵が浮遊したままにすることを許可しますか？
 * 不許可 - false     許可 - true
 * @default true
 *
 * @param ---モーション---
 ...
 * @type number
 * @min 0
 * @desc スプライトにデフォルトの武器の画像インデックスを設定
 * 0を入れると画像は使用されません。
 * @default 0
 *
 ...
 * @parent ---武器---
 * @type animation
 * @desc この武器にデフォルトで使われる戦闘アニメーションを設定
 * @default 6
 *

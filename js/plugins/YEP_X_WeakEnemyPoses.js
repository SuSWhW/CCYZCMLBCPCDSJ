...
/*:ja
 * @plugindesc v1.03 (要YEP_BattleEngineCore) 敵の状態によって、異なる画像を表示できます。
 ...
 * 彼らは全戦闘を通して1つの外観を維持し、いかなる状況下でもそれを変えません。
 * このプラグインを使用すると、
 * 特定のHP割合やその他の条件下にある時、敵に異なる画像を設定できます。
 *
 * ===========================================================================
 * メモタグ
 * ===========================================================================
